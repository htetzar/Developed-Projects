<%@ Page Title="" Language="C#" MasterPageFile="UserAdmin.Master"AutoEventWireup="true" CodeFile="NewProperty.aspx.cs" Inherits="UserAdmin_NewProperty" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">   
    <h2 class="headstyle">Property Info</h2> 
    <div class="container">  
        <div class="row">   
    ...
    <div class="summit">
    <asp:Button ID="ButtonSubmit" runat="server" Text="Submit" Height="35px" Width="100px" OnClick="ButtonSummit_Click" />
        </div>           
            </div>
        </div>
</asp:Content>
